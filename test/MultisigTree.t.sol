...
contract MultisigTest is Test {
    ...
    function test_RevertWhen_MinApprovalsIsGreaterThanSignerListLengthInitialize()
        external
    ...
    function test_RevertWhen_MinApprovalsIsZeroInitialize()
        external
        givenANewlyDeployedContract
        givenCallingInitialize
    {
    ...
    function test_RevertWhen_MinApprovalsIsGreaterThanSignerListLengthUpdateSettings()
        external
    ...
    function test_RevertWhen_MinApprovalsIsZeroUpdateSettings() external whenCallingUpdateSettings {
        // It should revert
        // It should revert (with onlyListed false)
        // It should not revert otherwise
        vm.skip(true);
