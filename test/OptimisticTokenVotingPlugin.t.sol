...
contract OptimisticTokenVotingPluginTest is Test {
    ...
    // Getters
    function test_SupportsOptimisticGovernanceInterface() public view {
    ...
    function test_SupportsIOptimisticTokenVotingInterface() public view {
        bool supported = plugin.supportsInterface(
    ...
    function test_SupportsIMembershipInterface() public view {
        bool supported = plugin.supportsInterface(
    ...
    function test_GetProposalReturnsTheRightValues() public {
        ...
        actions[0].data = abi.encodeCall(
            OptimisticTokenVotingPlugin.totalVotingPower,
            (0)
        );
    ...
    function test_UpgradeToAndCallRevertsWhenCalledFromNonUpgrader() public {
        ...
        plugin.upgradeToAndCall(
            _pluginBase,
            abi.encodeCall(
                OptimisticTokenVotingPlugin.updateOptimisticGovernanceSettings,
                (settings)
            )
        );
    }
